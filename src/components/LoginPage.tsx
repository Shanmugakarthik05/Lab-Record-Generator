      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-300 py-6"
          >
          ...
          <div className="flex items-start gap-3 text-sm text-gray-600">
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed">
                Your login is secured by Supabase Auth. You must be signed in to generate or download lab records.
              </p>
            </div>
          </div>
        </div>
