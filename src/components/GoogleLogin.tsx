...
import { GoogleUser, saveAuthUser } from '../utils/auth';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-gray-900 mb-2">Welcome to Lab Record Generator</h1>
          ...
          <div className="flex items-start gap-3 text-sm text-gray-600">
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed">
                Your login is secured by Google. You must be signed in to generate or download lab records.
              </p>
            </div>
          </div>
        </div>
